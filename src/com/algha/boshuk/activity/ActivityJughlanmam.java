...
public class ActivityJughlanmam extends Activity {
	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jughlanmam);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityJughlanmam.this);
		header.setListener(new clickListener());
		header.setTextTitle("جۇغلانمام");
