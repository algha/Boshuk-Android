...
public class ActivityTemilirim extends Activity {

	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_temilirim);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityTemilirim.this);
		header.setListener(new clickListener());
		header.setTextTitle("تېمىلىرىم");
