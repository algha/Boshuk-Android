...
public class ActivitySoalim extends Activity {

	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_soalim);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivitySoalim.this);
		header.setListener(new clickListener());
		header.setTextTitle("سوئالىم");
