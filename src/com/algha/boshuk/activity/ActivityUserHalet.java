...
public class ActivityUserHalet extends Activity {

	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_halet);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityUserHalet.this);
		header.setListener(new clickListener());
		header.setTextTitle("ھالەت");
