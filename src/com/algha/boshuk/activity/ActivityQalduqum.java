...
public class ActivityQalduqum extends Activity {

	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qalduqum);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityQalduqum.this);
		header.setListener(new clickListener());
		header.setTextTitle("قالدۇقۇم");
