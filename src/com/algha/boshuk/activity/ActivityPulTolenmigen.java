...
public class ActivityPulTolenmigen extends Activity {

	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pul_tolenmigen);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityPulTolenmigen.this);
		header.setListener(new clickListener());
		header.setTextTitle("پۇل تۆلەنمىگەن");
