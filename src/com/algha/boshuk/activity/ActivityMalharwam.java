...
public class ActivityMalharwam extends Activity {

	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mal_harwam);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityMalharwam.this);
		header.setListener(new clickListener());
		header.setTextTitle("مال ھارۋام");
