...
public class ActivityIltimasim extends Activity {
	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_iltimasim);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityIltimasim.this);
		header.setListener(new clickListener());
		header.setTextTitle("ئىلتىماسىم");
