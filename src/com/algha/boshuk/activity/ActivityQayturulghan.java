...
public class ActivityQayturulghan extends Activity {

	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qayturulghan);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityQayturulghan.this);
		header.setListener(new clickListener());
		header.setTextTitle("قايتۇرۇلغانلىرى");
