...
public class ActivitySaqlanma extends Activity {

	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_saqlanma);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivitySaqlanma.this);
		header.setListener(new clickListener());
		header.setTextTitle("ساقلانمىلار");
