...
public class ActivityEgishish extends Activity {
	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_egishish);
	...
	private void InitializationView() {
		...
		Header header = new Header(ActivityEgishish.this);
		header.setListener(new clickListener());
		header.setTextTitle("ئەگىشىش");
