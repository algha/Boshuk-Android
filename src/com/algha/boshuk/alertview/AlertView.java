package com.algha.boshuk.alertview;
...
public class AlertView {
    ...
    protected void initHeaderView(ViewGroup viewGroup){
        ...
        //标题和消息
        MyTextView tvAlertTitle = (MyTextView) viewGroup.findViewById(R.id.tvAlertTitle);
        MyTextView tvAlertMsg = (MyTextView) viewGroup.findViewById(R.id.tvAlertMsg);
        if(title != null) {
    ...
    protected void initListView(){
        ...
        if(cancel != null && style == Style.Alert){
            ...
            MyTextView tvAlert = (MyTextView) itemView.findViewById(R.id.tvAlert);
    ...
    protected void initActionSheetViews(LayoutInflater layoutInflater) {
        ...
        initListView();
        MyTextView tvAlertCancel = (MyTextView) contentContainer.findViewById(R.id.tvAlertCancel);
        if(cancel != null){
